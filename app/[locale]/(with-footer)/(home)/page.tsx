...
export default async function Page() {
  ...
  return (
    <div className='relative w-full bg-white dark:bg-tap4-black'>
      <div className='relative mx-auto w-full max-w-pc flex-1 px-3 lg:px-0'>
        <div className='my-5 flex flex-col text-center lg:mx-auto lg:my-10 lg:gap-1'>
          <h1 className='text-2xl font-bold text-black dark:text-white lg:text-5xl'>{t('title')}</h1>
          <h2 className='text-balance text-xs font-bold text-black dark:text-white lg:text-sm'>{t('subTitle')}</h2>
        </div>
